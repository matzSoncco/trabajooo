...
class Equipment(models.Model):
    idEquipment = models.CharField(primary_key=True, editable=False, max_length=10)
    ...
    level = models.IntegerField(null=False, choices=LEVELS, default=-1)
    stock = models.IntegerField(null=False, default=0)
    guideNumber = models.IntegerField(null=False, default=0)
    image = models.ImageField(upload_to='uploads/', blank=True, null=True)
    serialNumber = models.IntegerField(null=False, default=0)
